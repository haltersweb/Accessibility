    ...
    var step = 0,
        ...
        spaScreens = [
            ...
            },
            {
                ...
                content: '<p>NVDA has a bug wherein a container\'s contents aren\'t read if the control that triggers the focus is a descendant of the container receiving focus. <a href="https://github.com/nvaccess/nvda/issues/6606">An NVDA bug</a> has been filed but the chance of fixing this is unknown.  Therefore the announcement is all the more important to allow someone using a screen-reader to know to arrow through new content.</p><p>Voice Over on iOS does not handle in-page linked content at all.  It will skip reading the content when focus is moved to the container.  A bug has been filed.</p>'
            }
        ];
